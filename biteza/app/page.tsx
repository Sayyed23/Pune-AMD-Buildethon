...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen pb-20 md:pb-0 bg-background font-sans text-foreground">
      ...
      <button className="fixed bottom-6 right-6 md:bottom-10 md:right-10 bg-foreground text-background shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 rounded-full p-4 flex items-center justify-center group z-50">
